...
// Centralized theme switcher for all pages.
const setTheme = (mode) => {
...
const homeLinks = document.querySelectorAll('a[href="#home"], a[href="index.html#home"], a[href="../index.html#home"]');
...
if (backToTop) {
  // Show back-to-top once user has scrolled past hero section.
...
if (revealItems.length > 0) {
  // Reveal elements on first viewport entry.
